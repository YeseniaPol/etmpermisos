...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-titulo h1 text-center font-weight-bolder text-white ">WIEW ROLE</div>
                        ...
                        <div class="container-fluid" id="cuerpoFormulario">  
                            ...
                            <nav class="breadcrumb navbar-dark bg-dark col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" title="Name"  id="name" name="name" value="{{old('name', $role->name)}}" placeholder="Enter a role" readonly/> <!---readonly-->
                                    <small class="form-control-feedback"></small>
                                </div>

                                <div class="form-group">
                                    <label for="numero_parte">Slug</label>
                                    <input type="text" class="form-control form-control-sm" title="Slug" id="slug" name="slug" value="{{old('slug',  $role->slug)}}" placeholder="Enter a slug" readonly/>
                                    <small class="form-control-feedback"></small>
                                </div>

                                <div class="form-group">
                                    <label for="cliente">Description</label>
                                    <textarea class="form-control form-control-sm" title="Description" id="description" name="description" placeholder="Enter a description" rows="4" readonly>{{old('description',  $role->description)}}</textarea><!--verificar el value-->
                                    <small class="form-control-feedback"></small>
                                </div>
...
<!--if determina la visualizacion de datos grabados en la BD-->
                            ...
                            <a class="btn btn-outline-success btn-sm m-1" href="{{route('role.edit', $role->id)}}">Edit</a>
                            </div>
